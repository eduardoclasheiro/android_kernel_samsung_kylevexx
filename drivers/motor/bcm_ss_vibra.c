...
#if defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV01) || defined(CONFIG_MACH_HAWAII_SS_LOGAN_REV00)
	printk(KERN_NOTICE "Vibrator: temporary blocked for wrong connection\n");
	return;
#endif
	if( timeout == 0 )
	{
...
#if defined(CONFIG_MACH_CAPRI_SS_CRATER) || defined(CONFIG_MACH_HAWAII_SS_KYLEVE) || defined(CONFIG_MACH_HAWAII_SS_KYLEPRO) || defined(CONFIG_MACH_HAWAII_SS_KYLEPRODS)
	vib_voltage = 3300000;
#else
	vib_voltage = 3000000;
#endif
